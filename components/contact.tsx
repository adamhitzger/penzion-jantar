...
export default function Contact(){
    ...
    return(
        <section id="kontakt" className="flex flex-col text-2xl md:flex-row w-full text-card">
            <div className="w-full md:w-1/2 bg-foreground justify-start flex flex-col p-4 md:p-8 2xl:p-12">
            ...
            <Link href={"mailto:josef.mysicka@centrum.cz"}>josef.mysicka@centrum.cz</Link>
            <p><span className="text-3xl font-bold">IČO</span>:&nbsp;46482890</p>
            </div>
